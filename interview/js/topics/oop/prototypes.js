 ...
 * Когда вызывается какой-то метод, или идет обращение к свойству на объекте, сначала поиск этого свойства происходит в самом объекте. Если в этом объекте свойства с таким ключем не найдено, то поиск осуществляется в его прототипе, заходит в свойство __proto__ и ищет там. Очень похоже на цепочку областей видимости.
 */
