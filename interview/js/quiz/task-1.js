...
// console.log('generateList', generateList(10));
...
// console.log('generateArray', generateArray(12));


// -------------- Solution #1.3 --------------
const anotherGenerateArray = (num) =>
 [...new Array(num)].map((item, index) => index + 1);

// console.log('anotherGenerateArray', anotherGenerateArray(15));
